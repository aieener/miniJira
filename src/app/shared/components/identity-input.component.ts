...
@Component({
  ...
  template: `
    <div>
      <mat-form-field>
        <mat-select placeholder="Document Type" (selectionChange)="onIdTypeChange($event.value)" [(ngModel)]="identity.identityType">
    ...
    <div class="id-input">
      <mat-form-field class="full-width">
        <input matInput type="text" placeholder="Document Content" (change)="onIdNoChange($event.target.value)" [(ngModel)]="identity.identityNo">
        <mat-error>Error on Document Content</mat-error>
      </mat-form-field>
    </div>
  `,
  styles: [
